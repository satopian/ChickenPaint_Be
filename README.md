...
全レイヤーを結合すると1枚のレイヤーにしかならないペイントソフトもありますが、ChickenPaint Beには｢結合レイヤーを追加｣という機能があり、全レイヤーを結合した新しいレイヤーを追加できます。  
全レイヤーを結合したコピーが追加されるので、そのレイヤーに色収差フィルタをかければ、フィルタがかかって欲しくない箇所に消しゴムをかけて調整する事もできます。    
この方法を使えばレイヤーの構造はそのまま残りますので非破壊的に作業する事が可能になります。  
