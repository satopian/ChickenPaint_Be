...
<img width="511" height="282" alt="image" src="https://github.com/user-attachments/assets/531f52dd-9abf-4d40-8f6f-dbe2c3a42a62" /><br>

-「現在のレイヤーのみ｣がチェックされていない状態で、色収差フィルタを実行すると、全レイヤーを結合した新レイヤーが追加されます。その追加されたレイヤーに色収差フィルタがかかります。  
-「現在のレイヤーのみ｣がチェックされている時には、選択中のレイヤーにのみ色収差フィルタがかかります。
